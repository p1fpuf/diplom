      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-serif text-[#7D5A50] mb-2">StudioCherkasovoy</h3>
            <div className="flex items-start gap-3">
              <div>
                <p className="font-medium">Адрес студии</p>
                <p className="text-sm">Улица Татищева, 100А<br/>Екатеринбург</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+79991234567" className="text-sm hover:text-[#7D5A50] transition-colors">
                  +7 (999) 123-45-67
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5" />
                <a href="mailto:studio@example.com" className="text-sm hover:text-[#7D5A50] transition-colors">
                  studio@example.com
                </a>
              </div>
            </div>
          ...
          {/* Соцсети */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-[#7D5A50]">Мы в соцсетях</h4>
